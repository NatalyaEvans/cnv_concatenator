...
output_name='out.csv' #This is the name of the file that this code outputs. The default is output_name='out.xlsx'
...
data2.to_csv(output_name,index=False) #outputs the concatenated data. Change the file name by adjusting "ouput_name" at the top. Index referes to unique numbers on the left side of the xlsx sheet, these aren't really needed.  
